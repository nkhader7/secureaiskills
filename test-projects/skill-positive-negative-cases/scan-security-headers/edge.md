# Edge cases: scan-security-headers

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/scan-security-headers D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for HSTS issues. Note findings even inside test files.
