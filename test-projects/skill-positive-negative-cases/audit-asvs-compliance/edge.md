# Edge cases: audit-asvs-compliance

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/audit-asvs-compliance D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for ASVS Compliance issues. Note findings even inside test files.
