# Edge cases: scan-xml-security

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/scan-xml-security D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for XML Parser issues. Note findings even inside test files.
