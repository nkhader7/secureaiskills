# Edge cases: scan-for-xss

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/scan-for-xss D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for Unsafe HTML Sink issues. Note findings even inside test files.
