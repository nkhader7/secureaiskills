# Edge cases: detect-supply-chain-risks

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/detect-supply-chain-risks D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for Dependency Confusion issues. Note findings even inside test files.
