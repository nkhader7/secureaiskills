# Edge cases: detect-secrets

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/detect-secrets D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for Cloud Credentials issues. Note findings even inside test files.
