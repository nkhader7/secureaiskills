# Edge cases: audit-logging-monitoring

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/audit-logging-monitoring D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for Auth Events issues. Note findings even inside test files.
