# Edge cases: scan-api-security

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/scan-api-security D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for Authentication/Authorization issues. Note findings even inside test files.
