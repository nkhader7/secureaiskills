# Edge cases: scan-exception-handling

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/scan-exception-handling D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for Fail Open issues. Note findings even inside test files.
