# Edge cases: generate-dependency-graph

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/generate-dependency-graph D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for Direct Dependencies issues. Note findings even inside test files.
