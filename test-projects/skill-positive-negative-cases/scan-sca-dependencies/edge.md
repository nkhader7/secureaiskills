# Edge cases: scan-sca-dependencies

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/scan-sca-dependencies D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for Vulnerable Package Inventory issues. Note findings even inside test files.
