# Edge cases: audit-crypto-usage

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/audit-crypto-usage D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for Weak Algorithms issues. Note findings even inside test files.
