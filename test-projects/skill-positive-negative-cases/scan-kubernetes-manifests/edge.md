# Edge cases: scan-kubernetes-manifests

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/scan-kubernetes-manifests D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for CIS Kubernetes Benchmark issues. Note findings even inside test files.
