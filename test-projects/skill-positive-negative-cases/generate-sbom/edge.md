# Edge cases: generate-sbom

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/generate-sbom D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for Format issues. Note findings even inside test files.
