# Edge cases: scan-container-image

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/scan-container-image D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for CIS Docker Benchmark issues. Note findings even inside test files.
