# Edge cases: threat-model-system

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/threat-model-system D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for Scope issues. Note findings even inside test files.
