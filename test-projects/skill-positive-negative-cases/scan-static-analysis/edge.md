# Edge cases: scan-static-analysis

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/scan-static-analysis D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for Tool Selection issues. Note findings even inside test files.
