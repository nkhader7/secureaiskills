# Edge cases: audit-auth-session-management

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/audit-auth-session-management D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for Credential Verification issues. Note findings even inside test files.
