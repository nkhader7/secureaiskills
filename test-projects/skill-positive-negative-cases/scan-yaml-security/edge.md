# Edge cases: scan-yaml-security

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/scan-yaml-security D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for Authentication issues. Note findings even inside test files.
