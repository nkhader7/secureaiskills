# Edge cases: scan-iac-security

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/scan-iac-security D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for Network Exposure issues. Note findings even inside test files.
