# Edge cases: scan-broken-access-control

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/scan-broken-access-control D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for Object Authorization issues. Note findings even inside test files.
