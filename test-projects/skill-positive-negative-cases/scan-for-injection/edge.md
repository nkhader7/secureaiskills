# Edge cases: scan-for-injection

Boundary conditions where the skill fires correctly but context matters.

## Edge 1 — Pattern in test file

**Request:** `/scan-for-injection D:\Download\CascadeProjects\secureaiskills\test-projects\skill-fixture/src`
Scan for Injection issues. Note findings even inside test files.
